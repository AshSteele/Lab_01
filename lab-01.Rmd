...
**Because some numerical data is missing so the average cannot be calculated**
...
**There are some outliers in the data that are much higher than the other values**
